  ...
  return [
    {
      ...
      description: `Search across 305 free, no-authentication-required APIs. Returns matching APIs with descriptions, URLs, and example calls. Use this before calling free_api_call to find the right API for your task.

Available categories: ai, animals, data, development, education, entertainment, environment, finance, food, fun, geocoding, government, health, media, music, news, science, security, sports, transportation, utility, weather.`,
      inputSchema: {
        type: 'object',
        properties: {
          query: {
